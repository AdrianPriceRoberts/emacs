...
| l | Lab notebook entry | plain | (file (lambda nil (let ((title (read-string Lab entry title: )) (page-id (read-string Page ID: ))) (vulpea-note-path (vulpea-create title nil :tags '(lab) :properties `((PAGE_ID , page-id) (CREATED , (format-time-string [%Y-%m-%d])) (ALIASES , page-id))))))) | * Notes |
** Vulpea UI
#+begin_src emacs-lisp
